...
import tm.card.AerobrakedAmmoniaAsteroid;
import tm.card.Algae;
import tm.card.AntiGravityTechnology;
import tm.card.Ants;
import tm.card.AquiferPumping;
...
import tm.card.BiomassCombustors;
...
import tm.card.CorporateStronghold;
...
import tm.card.EnergySaving;
import tm.card.EnergyTapping;
...
import tm.card.Fish;
import tm.card.Flooding;
import tm.card.FoodFactory;
import tm.card.FuelFactory;
...
import tm.card.InventionContest;
...
import tm.card.LagrangeObservatory;
...
import tm.card.Livestock;
import tm.card.LocalHeatTrapping;
import tm.card.LunarBeam;
import tm.card.MagneticFieldDome;
...
import tm.card.MedicalLab;
import tm.card.MethaneFromTitan;
import tm.card.MicroMills;
import tm.card.Mine;
...
import tm.card.TechnologyDemonstration;
import tm.card.TectonicStressPower;
import tm.card.TerraformingGanymede;
...
import tm.card.TundraFarming;
import tm.card.UndergroundCity;
import tm.card.UndergroundDetonations;
...
import tm.card.WaterSplittingPlant;
import tm.card.WavePower;
import tm.card.Windmills;
...
public abstract class Cards {
    ...
    public static final Card BUSHES = new Bushes();
    ...
    public static final Card MICRO_MILLS = new MicroMills();
    public static final Card MAGNETIC_FIELD_GENERATORS = new MagneticFieldGenerators();
    public static final Card SHUTTLES = new Shuttles();
    public static final Card IMPORT_OF_ADVANCED_GHG = new ImportOfAdvancedGHG();
    public static final Card WINDMILLS = new Windmills();
    public static final Card TUNDRA_FARMING = new TundraFarming();
    public static final Card AEROBRAKED_AMMONIA_ASTEROID = new AerobrakedAmmoniaAsteroid();
    public static final Card MAGNETIC_FIELD_DOME = new MagneticFieldDome();
    public static final Card PETS = new Pets();
    public static final Card PROTECTED_HABITATS = new ProtectedHabitats();
    public static final Card PROTECTED_VALLEY = new ProtectedValley();
    public static final Card SATELLITES = new Satellites();
    public static final Card NOCTIS_FARMING = new NoctisFarming();
    public static final Card WATER_SPLITTING_PLANT = new WaterSplittingPlant();
    public static final Card HEAT_TRAPPERS = new HeatTrappers();
    public static final Card SOIL_FACTORY = new SoilFactory();
    public static final Card FUEL_FACTORY = new FuelFactory();
    public static final Card ICE_CAP_MELTING = new IceCapMelting();
    public static final Card CORPORATE_STRONGHOLD = new CorporateStronghold();
    public static final Card BIOMASS_COMBUSTORS = new BiomassCombustors();
    public static final Card LIVESTOCK = new Livestock();
    public static final Card OLYMPUS_CONFERENCE = new OlympusConference();
    public static final Card RAD_SUITS = new RadSuits();
    public static final Card AQUIFER_PUMPING = new AquiferPumping();
    public static final Card FLOODING = new Flooding();
    public static final Card ENERGY_SAVING = new EnergySaving();
    public static final Card LOCAL_HEAT_TRAPPING = new LocalHeatTrapping();
    public static final Card PERMAFROST_EXTRACTION = new PermafrostExtraction();
    public static final Card INVENTION_CONTEST = new InventionContest();
    public static final Card PLANTATION = new Plantation();
    public static final Card POWER_INFRASTRUCTURE = new PowerInfrastructure();
    public static final Card INDENTURED_WORKERS = new IndenturedWorkers();
    public static final Card LAGRANGE_OBSERVATORY = new LagrangeObservatory();
    public static final Card TERRAFORMING_GANYMEDE = new TerraformingGanymede();
    public static final Card IMMIGRATION_SHUTTLES = new ImmigrationShuttles();
    public static final Card RESTRICTED_AREA = new RestrictedArea();
    public static final Card IMMIGRANT_CITY = new ImmigrantCity();
    public static final Card ENERGY_TAPPING = new EnergyTapping();
    public static final Card UNDERGROUND_DETONATIONS = new UndergroundDetonations();
    public static final Card SOLETTA = new Soletta();
    public static final Card TECHNOLOGY_DEMONSTRATION = new TechnologyDemonstration();
    public static final Card RAD_CHEM_FACTORY = new RadChemFactory();
    public static final Card SPECIAL_DESIGN = new SpecialDesign();
    public static final Card MEDICAL_LAB = new MedicalLab();
    public static final Card AI_CENTRAL = new AICentral();

    public static Deque<Card> buildDeck(Random r) {
        final List<Card> list = new ArrayList<>();
        final Field[] fields = Cards.class.getDeclaredFields();
        for (Field f : fields) {
            try {
                list.add((Card) f.get(null));
            } catch (IllegalAccessException e) {
                throw new RuntimeException(e);
            }
        }
        // Shuffle the 208 cards
        final Deque<Card> deck = new ArrayDeque<>(list.size());
        while (!list.isEmpty()) {
            deck.add(list.remove(r.nextInt(list.size())));
        }
        return deck;
    }
}
