...
public class Game extends JPanel {
    ...
    public Game() {
        ...
        deck.add(new MiningRights());
        deck.add(new Sponsors());
        deck.add(new ElectroCatapult());
        deck.add(new EarthCatapult());
        ...
        deck.add(new SolarWindPower());
        deck.add(new IceAsteroid());
        deck.add(new QuantumExtractor());
        deck.add(new GiantIceAsteroid());
        ///
        ...
        deck.add(new Mine());
        deck.add(new VestaShipyard());
        deck.add(new BeamFromThoriumAsteroid());
        deck.add(new Mangrove());
        deck.add(new Trees());
        deck.add(new GreatEscarpmentConsortium());
        deck.add(new MineralDeposit());
        deck.add(new MiningExpedition());
        deck.add(new MiningArea());
        deck.add(new BuildingIndustries());
        deck.add(new LandClaim());
